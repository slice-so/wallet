...
const validUserOperation: UserOperation<"0.7"> = {
  callData: "0x",
...
describe("Slice wallet chain policy", () => {
  test("admits only provisioned wallet chains", () => {
    expect(isSupportedSliceWalletChainId(1)).toBe(true)
    expect(isSupportedSliceWalletChainId(10)).toBe(true)
    expect(isSupportedSliceWalletChainId(8453)).toBe(true)
    expect(isSupportedSliceWalletChainId(42_161)).toBe(true)
    expect(isSupportedSliceWalletChainId(31_337)).toBe(false)
